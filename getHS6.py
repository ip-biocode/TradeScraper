...
## Test above example URL
import urlparse, requests, zipfile, io
import pandas as pd
...
headers_list = list(test_file[:0])
headers = [headers_list[1], headers_list[6],headers_list[8], headers_list[9], headers_list[11], headers_list[12], headers_list[14], headers_list[15], headers_list[20]]
...
import glob, os.path, os, zipfile, io
...
## Attach ISO codes for reporters and partners
import pycountry
